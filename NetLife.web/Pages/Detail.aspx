...
<%@ Register Src="../Controls/Lists/HotRight.ascx" TagName="HotRight" TagPrefix="uc9" %>
<%@ Register Src="../Controls/Home/VideoClip.ascx" TagName="VideoClip" TagPrefix="uc6" %>
<%@ Register Src="~/Controls/Lists/HotRight.ascx" TagPrefix="uc1" TagName="HotRight" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        ...
        <div class="col-md-3-custom-main">
            ...
            <%--<uc8:HotRight ID="HotRigh1t" runat="server" />--%>
            ...
            <uc9:HotRight runat="server" ID="HotRight" />
