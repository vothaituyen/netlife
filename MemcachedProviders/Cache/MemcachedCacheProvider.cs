...
namespace MemcachedProviders.Cache
{
    public class MemcachedCacheProvider : CacheProvider
    {
        ...
        private string _strMemcachedSection = string.Empty;
        private string _strCategoryID = string.Empty;
        ...
        {            
            ...
            {
                _strName = "MemcachedProviders.CacheProvider";
            }
            else
            {
                _strName = name;
            ...
            _strMemcachedSection =
                ConfigurationUtil.GetConfigValue(config["memcachedSection"], string.Empty);

            _strCategoryID =
                ConfigurationUtil.GetConfigValue(config["categoryId"], string.Empty);

            this._client = MemcachedProviders.Common.MemcachedClientService.GetInstance(_strMemcachedSection).Client;
        ...
        public override string MemcachedSection
        {
            get
            {
                return this._strMemcachedSection;
            }
            set
            {
                this._strMemcachedSection = value;
            }
        }
        ...
        /// thanhtn
        /// </summary>
        /// <returns>Current provider state</returns>
