...
//                    a(d).outerHeight(); var e = a(d).outerWidth(); a("#lean_overlay").css({ display: "block", opacity: 0 }); a("#lean_overlay").fadeTo(200, c.overlay); a(d).css({ display: "block", position: "fixed", opacity: 0, "z-index": 110, left: "50%", "margin-left": -(e / 2) + "px", top: c.top + "px" }); c.scroll && (a("html").css({ overflow: "hidden" }), a("body").css({ overflow: "hidden" })); a(d).fadeTo(200, 1); b.preventDefault()
//                })
//            })
//        }
//    })
