...
namespace NetLifeMobile.Controls.Home
{
    public partial class Categorys : System.Web.UI.UserControl
    {
        ...
        //string listNews = "<a href=\"{1}\"><li>{2}</li> </a>"; //  edit 20160527
        //string listNews = "<li class=\"news_home\"><div class=\"row\"><span class=\"col-xs-2 col-sm-1 col-md-1\"><a href=\"{1}\"><img src=\"{3}\" alt=\"\" height=\"50\" width=\"60\"></span> <span class=\"col-xs-10 title\" style=\"padding-left:20px;\">{2}</a></span></div></li>"; //  add 20160527
