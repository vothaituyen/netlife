    ...
    public partial class Detail : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ne != null)
            {
                ...
                ltrContent.Text = newString.Replace("src=\"/Uploaded/", "src=\"http://static.netlife.vn/Uploaded/").Replace("<div id=\"vmcbackground\"></div>", string.Format("<div id=\"vmcbackground\" class=\"vmcbackground_1\"><center>{0}</center></div>", adsContent)).Replace("<div id=\"vmcbackgroundExtend\"></div>", string.Format("<div id=\"vmcbackground\" class=\"vmcbackground_2\"><center>{0}</center></div>", adsContentExtend)).Replace("<div id=\"vmcbackgroundPerfect\"></div>", string.Format("<div id=\"vmcbackground\" class=\"vmcbackground_3\"><center>{0}</center></div>", adsContentPerfect));
